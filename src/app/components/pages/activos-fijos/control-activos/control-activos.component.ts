...
@Component({
  selector: 'app-control-activos',
  templateUrl: './control-activos.component.html',
  styleUrls: ['./control-activos.component.css']
})
export class ControlActivosComponent implements OnInit {
  ...
  verificarRelacionado() {
    ...
    if (Cod_Activo != null && Cod_Activo.length == 9) {
        ...
        (result: any) => {
          ...
          if (result != null) {
            ...
            this.formulario.patchValue({
              ...
              moneda: result['moneda'] != '' && result['moneda'] != null ? result['moneda'].trim() : '',
              ...
              nuevoCodActivo: result['nuevoCodActivo'] != null ? result['nuevoCodActivo'] : '',
