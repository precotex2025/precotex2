...
import { DialogCentroCostoComponent } from './dialog-centro-costo/dialog-centro-costo.component';
...
export class CentrosCostoComponent implements OnInit {
  ...
  agregarDescripcion(){
    let datos = {
      tipo: 1,
      boton: 'Guardar',
      cabecera: 'Crear Nuevo Centro de Costo'
    }
    let dialogRef = this.dialog.open(DialogCentroCostoComponent, {
      disableClose: true,
      panelClass: 'my-class',
      data: {
        data: datos
  ...
  openModificarActivo(descripcion: data_det) {
    ...
    let datos = {
      tipo: 2,
      boton: 'Actualizar',
      cabecera: 'Actualizar Centro de Costo',
      data: descripcion
    }
    let dialogRef = this.dialog.open(DialogCentroCostoComponent, {
      disableClose: true,
