...
export class ExceljsvalorService {

    constructor() {
    }


    public exportExcel(excelData: any, total: number) {
        ...
        // Total
        worksheet.mergeCells('M1:O4');
        let dateCell2 = worksheet.getCell('M1');
        dateCell2.value = "Valor Total: " + total;
        dateCell2.font = {
            name: 'Calibri',
            size: 12,
            bold: true
